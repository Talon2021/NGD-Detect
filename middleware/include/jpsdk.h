 ...
 * @LastEditTime: 2024-07-04 15:37:44
...
typedef int (*FRAME_HOOK_CALLBACK)(FRAME_HOOK_INFO* param);
...
int JPSys_EncRegisterFrameHookCallback(FRAME_HOOK_CALLBACK FrameHookCallback);
